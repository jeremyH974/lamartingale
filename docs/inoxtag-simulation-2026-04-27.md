...
> Synthèse de la simulation Inoxtag menée le 2026-04-27 dans le cadre de la stratégie pilote Stefani. Méthode complète et livrables (transcript, prompts, JSON, scripts) archivés sur la branche `pilot-simulation-inoxtag` (origin), jamais mergée sur master.
